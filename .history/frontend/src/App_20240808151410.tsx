...
const App: React.FC = () => {
  const { isAuthenticated, isLoading, authToken, logout } = useAuth();
  const [activeTab, setActiveTab] = React.useState('dashboard');

  console.log('App render - isAuthenticated:', isAuthenticated, 'isLoading:', isLoading, 'authToken exists:', !!authToken);
